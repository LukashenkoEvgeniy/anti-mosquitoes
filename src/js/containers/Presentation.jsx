...
export default function Presentation() {
    return (
        ...
        >
            ...
            <p>Москитная сетка – это свежий воздух без досаждающих насекомых. Ею легко пользоваться, и она подходит почти ко всем моделям окон. Она легко монтируется и демонтируется.</p>
